...
//    }
    ...
    @PostMapping("/save")
    public Annonce save(@RequestBody String description, @RequestBody int nbr_place, @RequestBody int nbr_porte, @RequestBody int etat, @RequestBody double kilometrage, @RequestBody double conso, @RequestBody Date date_annonce, @RequestBody int annee, @RequestBody int id_user, @RequestBody int id_carburant, @RequestBody int id_transmission, @RequestBody int id_moteur, @RequestBody int id_categorie, @RequestBody int id_couleur, @RequestBody int id_modeles, @RequestBody int id_marque)
    {
        Annonce annonce = new Annonce(0, description, nbr_place, nbr_porte, etat, kilometrage, conso, date_annonce, annee, id_user, id_carburant, id_transmission, id_moteur, id_categorie, id_couleur, id_modeles, id_marque);
        return annonceRepository.save(annonce);
    }
